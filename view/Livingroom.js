...
export default class Livingroom extends Component {
  static navigationOptions = ({ navigation }) => {
    return {
      title: navigation.getParam("title", "Livingroom"),
  ...
  constructor(props){
    ...
    this.state = {
      isFetching: false,
      data: require("../db/Livingroom.json")
    }
  }
  ...
  addObject(){
    ...
    this.state.data[Object.keys(this.state.data).length] = {id: "2", name: "Small lamp", isLight: true, remainingLight: 200, lights: "On", buttonColor: "red", room: "Livingroom"}
