...
export default class Hallway extends Component {
  ...
  constructor(props){
    ...
    this.state = {
      data: [{id: "0", name: "Ultra lamp", isLight: true, remainingLight: 500, lights: "On", buttonColor: "red"},
            {id: "1", name: "Radio", isLight: false, remainingLight: 200, lights: "On", buttonColor: "red"}]
    }
  }
