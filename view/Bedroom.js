...
import {Platform, StyleSheet, Text, View, Button, Alert, ImageBackground, TouchableOpacity, Image, TextInput} from 'react-native';
...
export default class Bedroom extends Component {
  ...
  constructor(props){
    ...
    this.state = {
      data: [{id: "0", name: "Big lamp", isLight: true, remainingLight: 500, lights: "On", buttonColor: "red"},
            {id: "1", name: "Tv", isLight: false, remainingLight: 200, lights: "On", buttonColor: "red"}]
    }
  }
