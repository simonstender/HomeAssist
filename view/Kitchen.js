...
export default class Kitchen extends Component {
  ...
  addObject(){
    ...
    this.state.data[Object.keys(this.state.data).length] = {id: "2", name: "Coffe machine", isLight: false, remainingLight: 200, lights: "On", buttonColor: "red", room: "Kitchen"}
